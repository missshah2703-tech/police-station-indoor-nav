...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "nav.turnAround": "Turn around, you are facing the wrong direction",
    "nav.slightLeft": "Turn slightly left to stay on route",
    "nav.slightRight": "Turn slightly right to stay on route",
    "nav.keepStraight": "Keep going straight",
    "nav.arrived": "You have reached your destination",
    "nav.nextTurn": "In {distance} meters, {direction}",
    "nav.offRoute": "You seem to be off route. Recalibrating.",
  },
  ar: {
    ...
    "nav.turnAround": "استدر، أنت تواجه الاتجاه الخاطئ",
    "nav.slightLeft": "انعطف قليلاً لليسار للبقاء على المسار",
    "nav.slightRight": "انعطف قليلاً لليمين للبقاء على المسار",
    "nav.keepStraight": "استمر بالمشي مباشرة",
    "nav.arrived": "لقد وصلت إلى وجهتك",
    "nav.nextTurn": "بعد {distance} متر، {direction}",
    "nav.offRoute": "يبدو أنك خارج المسار. إعادة المعايرة.",
  },
  hi: {
    ...
    "nav.turnAround": "पीछे मुड़ो, तुम उल्टी दिशा में खड़े हो",
    "nav.slightLeft": "थोड़ा बाएं मुड़ो, रास्ते पर रहो",
    "nav.slightRight": "थोड़ा दाएं मुड़ो, रास्ते पर रहो",
    "nav.keepStraight": "सीधे चलते रहो",
    "nav.arrived": "आप अपनी मंज़िल पर पहुंच गए",
    "nav.nextTurn": "{distance} मीटर बाद, {direction}",
    "nav.offRoute": "आप रास्ते से भटक गए हो। फिर से सेट कर रहे हैं।",
  },
};
